...
<body>
    ...
    <section class="produtos">
        ...
        <?php
            $query = "select cod_produto,prod_nome,prod_imagem,prod_preco from tb_produto where prod_data <= (select max(prod_data) from tb_produto) and prod_tipo = 'Calcado' order by prod_data desc limit 8";
